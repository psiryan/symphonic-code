...
#ifndef AMAROK_SONYNWMEDIADEVICE_H
#define AMAROK_SONYNWMEDIADEVICE_H
...
class SonyNwMediaItem;
class SonyNwMediaFile;
class SonyNwMediaDeviceConfigDialog;
class PodcastEpisodeBundle;

class QStringList;

typedef QMap<QString, SonyNwMediaFile*> MediaFileMap;
typedef QMap<SonyNwMediaItem*, SonyNwMediaFile*> MediaItemMap;

class SonyNwMediaDevice : public MediaDevice
{
    Q_OBJECT

    friend  class SonyNwMediaDeviceConfigDialog;
    ...
    public:
        ...
        SonyNwMediaFile *getInitialFile() { return m_initialFile; }
    ...
    private:
        ...
        SonyNwMediaDeviceConfigDialog *m_configDialog;
};
