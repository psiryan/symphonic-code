...
public class Mp4DataBox extends AbstractMp4Box
{
    ...
    public Mp4DataBox(Mp4BoxHeader header, ByteBuffer dataBuffer)
    {
        ...
        {
            //TO DO byte data length seems to be 1 for pgap and cpil but 2 for tmpo ?
     ...
     * @return numbers
     */
    //TO DO this is only applicable for numeric databoxes, should we subclass dont know type until start
