...
public abstract class AbstractID3v2Frame extends AbstractTagFrame implements TagField
{
     ...
     */
    //TO DO the identifier checks should be done in the relevent subclasses
     ...
     */
    //TO DO, this is confusing only returns the frameId, which does not neccessarily uniquely
    //identify the frame
    public String getId()
    {
    ...
    //TO DO:needs implementing but not sure if this method is required at all
