...
public class MP3File extends AudioFile
{
     ...
     * <p/>
     * TO DO:shouldnt we be handing TagExceptions:when will they be thrown
     *
     * @param file
     * @param loadOptions
     * @throws IOException
    ...
    public MP3File(File file, int loadOptions, boolean readOnly) throws IOException, TagException, ReadOnlyFileException, InvalidAudioFrameException
    {
        ...
        try
        {
            ...
            //TO DO:if have both should we merge
     ...
     * TO DO disabled until Lyrics3 fixed
    ...
    */
     ...
     */
    @Override
    //TO DO Should be able to change the Default
