...
public class OggInfoReader
{
    ...
    public GenericAudioHeader read(RandomAccessFile raf) throws CannotReadException, IOException
    {
        ...
        //which must be set.
        //TO DO should do buffering to cut down the number of file reads
        raf.seek(0);
        ...
        //TO DO this calculation should be done within identification header
        ...
        {
            //TO DO need to remove comment from raf.getLength()
