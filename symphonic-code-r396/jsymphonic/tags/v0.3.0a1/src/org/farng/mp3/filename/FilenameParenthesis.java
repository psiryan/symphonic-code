...
public class FilenameParenthesis extends FilenameDelimiter {
    ...
    public String composeFilename() {
        ...
        builder.append(' ');
        builder.append(openDelimiter);
        if (middleComposite != null) {
            builder.append(middleComposite.composeFilename());
        }
        builder.append(TagOptionSingleton.getInstance().getCloseParenthesis(openDelimiter));
        builder.append(' ');
        if (getAfterComposite() != null) {
