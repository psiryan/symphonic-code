...
public class TagConstant {
     ...
     * ID3v2.4 Header Footer bit mask
     */
    public static final int MASK_V24_COMPRESSION = BIT3;
    /**
     * ID3v2.4 Header Footer bit mask
     */
    public static final int MASK_V24_ENCRYPTION = BIT2;
    /**
     * ID3v2.4 Header Footer bit mask
     */
    public static final int MASK_V24_FRAME_UNSYNCHRONIZATION = BIT1;
    /**
     * ID3v2.4 Header Footer bit mask
     */
    public static final int MASK_V24_DATA_LENGTH_INDICATOR = BIT0;
    /**
    ...
    static {
        ...
        genreIdToString.put(new Long(255), "None");
        ...
        languageIdToString.put("vol", "Volap_k");
