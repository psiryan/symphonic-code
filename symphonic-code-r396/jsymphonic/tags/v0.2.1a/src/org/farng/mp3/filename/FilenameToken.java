...
public class FilenameToken extends AbstractFilenameComposite {
    ...
    public FilenameToken(final FilenameToken copyObject) {
        ...
        try {
            ...
            throw new IllegalStateException("IllegalAccessException: No access to run constructor to create copy", ex);
        } catch (InstantiationException ex) {
            throw new IllegalStateException("InstantiationException: Unable to instantiate constructor to copy", ex);
        }
