...
public class JSymphonic extends javax.swing.JFrame {
    ...
    public JSymphonic(boolean debug) {
        ...
        if( !omgaudioDir.exists() ) {
            ...
            if(debug) {System.out.println("Player's information read.");}
    ...
    public void setPlayer(File omgaudioDir) {
        ...
        player = new GenericNW(omgaudioDir, omgaudioDir.getParentFile().getName(), "", 4, sourceIcon, this);
    }
    ...
    public void upDateGUI(int action) {
        switch(action) {
            default : 
                ...
                lblDeviceName.setText(player.getSourceName());
    ...
    public void initializeTransfert() {
    ...
    private void initComponents() {
        ...
        jLabel2.setText(java.util.ResourceBundle.getBundle("org/naurd/media/jsymphonic/manager/languages").getString("TRANSFERT_INFORMATION"));
