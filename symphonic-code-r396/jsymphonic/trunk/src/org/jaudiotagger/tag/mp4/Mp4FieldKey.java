...
public enum Mp4FieldKey
{
    ...
    PODCAST_URL("purl", NUMERIC),   //TO DO Actually seems to store text but is marked as numeric!
    EPISODE_GLOBAL_ID("egid", NUMERIC),   //TO DO Actually seems to store text but is marked as numeric!
