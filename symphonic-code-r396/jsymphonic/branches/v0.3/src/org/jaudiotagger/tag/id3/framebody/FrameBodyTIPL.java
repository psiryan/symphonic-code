 ...
 * <p/>
 * TO DO currently just reads the first String when directly from file, this will be fixed when we add support for
 * multiple Strings for all ID3v24Frames
 * <p/>
 * TO DO currently just reads all the values when converted from the corresponding ID3v23 Frame IPLS as a single value
