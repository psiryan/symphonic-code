...
public class ID3v23Tag extends AbstractID3v2Tag
{
     ...
     * <p/>
     * TO DO this is incorrect, because of subclasses
     *
     * @return size of tag
     */
    public int getSize()
     ...
     * <p/>
     * TO DO Calculate the CYC Data Check
     * TO DO Reintroduce Extended Header
     *
     ...
     * Write tag to file
     * <p/>
     * TO DO:we currently never write the Extended header , but if we did the size calculation in this
