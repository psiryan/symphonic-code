...
public abstract class AbstractID3v2Tag extends AbstractID3Tag implements Tag
{
     ...
     */
    //TO DO:This method is problematic because sometimes it returns a list and sometimes a frame, we need to
     ...
     * @return
     */
    //TO DO:we should be just be using the bodies toString() method so we dont have if statement in this method
     ...
     *              <p/>
     */
    //TO DO needs to ensure do not add an invalid frame for this tag
    //TO DO what happens if already contains a list with this ID
     ...
     *                     <p/>
     */
    //TO DO should clear all data and preferably recover lost space and go upto end of mp3s
     ...
     * @throws IOException TO DO should be abstract
     */
     ...
     * <p/>
     * TO DO:this appears to have little affect on Windows Vista
     *
     * @param fileChannel
    ...
    private void replaceFile(File originalFile,File newFile) throws IOException
    {
        ...
        if (!renameResult)
        {
            ...
            if(!renameOriginalResult)
            {
                //TO DO now if this happens we are left with testfile.old instead of testfile.mp3
     ...
     * versions
     * <p/>
     * TO DO the logic here is messy and seems to be specific to date fields only when it
            ...
            if (newFrame.getBody() instanceof FrameBodyTDRC)
            {
                ...
                */
                ...
                else
                {
                    ...
                    //TO DO may want to store this somewhere
    ...
    public Iterator<TagField> getFields()
    {
        ...
        return new Iterator<TagField>()
        {
            ...
            //TO DO assumes if have entry its valid, but what if empty list but very different to check this
