...
public class Mp4TagWriter
{
    ...
    public void write(Tag tag, RandomAccessFile raf, RandomAccessFile rafTemp) throws CannotWriteException, IOException
    {
        ...
        //TO DO we shouldn't need all these variables, and some are very badly named - used by new and old methods
        int oldIlstSize = 0;
        ...
        if(udtaHeader !=null)
        {
            ...
            if(metaHeader != null)
            {
                ...
                else
                {
                    ...
                    //TO DO Should we create a hdlr atom
                    else
                    {
        ...
        //TO DO this logic probably incomplete
