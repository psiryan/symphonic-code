//package org.naurd.media.nwe00xmp3filemanager;
...
public class Java6ToolBox {
    ...
    */
    private static void dfError(String message) {
        ...
        System.out.println(message + " - use Java 6 or greater to avoid needing \"df\" at all");
        javax.swing.JOptionPane.showMessageDialog(
            null,
            java.util.ResourceBundle.getBundle("org/naurd/media/nwe00xmp3filemanager/language").getString("CANNOT_CHECK_DISK_SPACE"),
            "Warning",
